...
@Component({
    selector: 'request-photoid',
      standalone: true,
      templateUrl: './request-photoid.component.html',
...
export class RequestPhotoIDComponent {
    ...
    constructor(
        private _activatedRoute: ActivatedRoute,
            ...
            public _dialogRef: MatDialogRef<RequestPhotoIDComponent>,
    ) 
    {        
        this._gfs.showLog('RequestPhotoID', 'constructor', '', null);
        this._gfs.allowCall = false;
    }

    ngAfterViewInit(): void {
        this._gfs.showLog('RequestPhotoID', 'ngAfterViewInit', '', null);
    }
    
    ngOnInit(): void {
        this._gfs.showLog('RequestPhotoID', 'ngOnInit', '', null);
    }

    setData(eid: number): void {
        this._gfs.showLog('RequestPhotoID', 'setData', '', null);
    }
