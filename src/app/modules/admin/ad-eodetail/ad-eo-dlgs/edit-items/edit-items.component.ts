...
export class EditItemsComponent {
    ...
    constructor(
        private _activatedRoute: ActivatedRoute,
            ...
            public _dialogRef: MatDialogRef<EditItemsComponent>,
    ) 
    {        
        this._gfs.showLog('EditItems', 'constructor', '', null);
        this._gfs.allowCall = false;
    }

    ngAfterViewInit(): void {
        this._gfs.showLog('EditItems', 'ngAfterViewInit', '', null);
    }
    
    ngOnInit(): void {
        this._gfs.showLog('EditItems', 'ngOnInit', '', null);
    }
    
    setData(eid: number): void {
        this._gfs.showLog('EditItems', 'setData', '', null);
    }
